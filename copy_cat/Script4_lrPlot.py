...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-dir', help='path/to/the/proof', type=str, default='proof')
    ...
    for lri in range(len(lr_list)):
        for i in range(5):
            ...
            save_path_dist = f'dists/{arg.dataset}_{i+1}_b{arg.batch_size}_a{lr_names[lri]}.npy'
