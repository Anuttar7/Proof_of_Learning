...
if __name__ == '__main__':
    ...
    dref = np.array(np.load(f'dref/{arg.dataset}_dref.npy'))
    ...
    for f in range(len(freq_list)):
        for i in range(5):
            ...
            save_path_dist = f'dists/{arg.dataset}_{i+1}_b{arg.batch_size}_k{freq_list[f]}.npy'
